...
class NavigationService
{
     ...
     */
    public function putNavigationLink(
        NavigationLinkBag $link_bag,
        NavigationLink $link
    ): void {
     ...
     * @return void
     */
    public function resetNavigationLinkBagPointers(NavigationLinkBag $link_bag
    ): void {
     ...
     * @return string
     */
    public function getActiveNavigationLinkID(NavigationLinkBag $link_bag
    ): ?string {
     ...
     */
    public function setActiveNavigationLinkID(
        NavigationLinkBag $link_bag,
        string $id
    ): void {

        // Find the active link entity by its ID
        $active_link = $this->findNavigationLinkFromID(
            $link_bag,
            $id
        );
     ...
     * @param NavigationLinkBag $link_bag The NavigationLinkBag instance to use
     */
    public function calculateNextPrevNavigationLinks(NavigationLinkBag $link_bag
    ): void {
        ...
        $previous_link = $this->findPreviousNavigationLink(
            $link_bag,
            $id
        );
        $next_link     = $this->findNextNavigationLink(
            $link_bag,
            $id
        );
     ...
     */
    private function findNavigationLinkFromID(
        NavigationLinkBag $link_bag,
        string $id
    ): ?NavigationLink {
        ...
        foreach (
            $link_bag->getNavigationLinks() as $link
        ) {
     ...
     * @return NavigationLink
     */
    private function findPreviousNavigationLink(
        NavigationLinkBag $link_bag,
        ?string $id
    ): ?NavigationLink {
     ...
     * @return NavigationLink
     */
    private function findNextNavigationLink(
        NavigationLinkBag $link_bag,
        ?string $id
    ): ?NavigationLink {
