<?php
   ...
   class NavigationControllerTest extends TestCase
   {
      ...
      public function testCreateNavigationController (): NavigationController
      {
         ...
         $this->assertInstanceOf( NavigationController::class,
                                  $navigation );

         // Add navigation_links for testing
         $navigation->putNavigationLink( NavigationPorter::getInstance()
                                                         ->newNavigationLink( "index1",
                                                                              "/index1.php",
                                                                              "Index 1" ) );
         $navigation->putNavigationLink( NavigationPorter::getInstance()
                                                         ->newNavigationLink( "index2",
                                                                              "/index2.php",
                                                                              "Index 2" ) );
         $navigation->putNavigationLink( NavigationPorter::getInstance()
                                                         ->newNavigationLink( "index3",
                                                                              "/index3.php",
                                                                              "Index 3" ) );
         $navigation->putNavigationLink( NavigationPorter::getInstance()
                                                         ->newNavigationLink( "index4",
                                                                              "/index4.php",
                                                                              "Index 4" ) );
       ...
       */
      public function testNavigationControllerActiveLink ( NavigationController $navigation ): void
      {
         ...
         $this->assertInstanceOf( NavigationLink::class,
                                  $active_link );

         // Test the link data
         $this->assertIsString( $active_link->getID() );
         $this->assertEquals( 'index3',
                              $active_link->getID() );
       ...
       * @depends testCreateNavigationController
       */
      public function testNavigationControllerPreviousLink ( NavigationController $navigation ): void
      {
       ...
       * @depends testCreateNavigationController
       */
      public function testNavigationControllerNextLink ( NavigationController $navigation ): void
      {
       ...
       * @depends testCreateNavigationController
       */
      public function testNavigationControllerFirstLink ( NavigationController $navigation ): void
      {
         ...
         $this->assertNotInstanceOf( NavigationLink::class,
                                     $previous_link );
       ...
       * @depends testCreateNavigationController
       */
      public function testNavigationControllerLastLink ( NavigationController $navigation ): void
      {
